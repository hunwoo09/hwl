...
export default function WorkPage() {
  ...
  // ── Mobile layout: editorial case-study scroll ────────────────────────────
  // One vertical read: oversized title block, then every media item full-width
  // in a contact-sheet column, scroll-revealed. No pager, no filmstrip — the
  // works ARE the page. Desktop's horizontal theater stays untouched.
  if (isMobile) {
